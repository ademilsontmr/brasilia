  ...
  return {
    meta: [
      ...
      { name: "description", content: HOME_DESCRIPTION },
      {
        name: "keywords",
        content:
          "cassino Brasília, cassino Distrito Federal, domínio premium à venda, comprar domínio, cassinodebrasilia.com.br, turismo Brasília, hotelaria, resorts, regulação cassinos brasil, entretenimento regulado",
      },
